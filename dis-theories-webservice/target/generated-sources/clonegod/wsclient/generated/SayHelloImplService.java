 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://jaxws.ws.rmi.clonegod/", wsdlLocation = "http://127.0.0.1:9000/vip/sayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://jaxws.ws.rmi.clonegod/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9000/vip/sayHello?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://jaxws.ws.rmi.clonegod/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.ws.rmi.clonegod/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
